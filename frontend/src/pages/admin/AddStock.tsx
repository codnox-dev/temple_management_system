...
// Use centralized API instance to avoid hardcoded ports
...
const AddStock = () => {
  ...
  const response = await api.post('/stock', itemToSend);
    ...
    <div className="space-y-6 text-white">
      ...
      <div className="bg-slate-900/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-purple-500/30">
        ...
        {!isLoading && !error && (
            ...
            {stockItems.map((item) => (
                <div key={item._id} className="bg-slate-800/50 rounded-lg p-4 border border-purple-500/20 hover:shadow-md hover:shadow-purple-500/10 transition-shadow">
